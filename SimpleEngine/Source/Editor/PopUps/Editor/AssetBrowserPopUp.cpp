...
namespace Editor
{
	AssetBrowserPopUp2::AssetBrowserPopUp2(const std::string& aName, NodeScriptingWindow* aNodeScriptWindow, MenuTabWindow* aNodeScriptParentTab, MenuItemPopUp* aNodeScriptButton)
		: PopUp(aName)
		, myNodeScriptingWindow(aNodeScriptWindow)
		, myNodeScriptParentTab(aNodeScriptParentTab)
		, myNodeScriptButton(aNodeScriptButton)
	...
	void AssetBrowserPopUp2::ViewFolders(const std::string& aStartDirectory, const std::string& aWindowName)
	{
	...
	void AssetBrowserPopUp2::DrawFilesInFolder(const std::string& aDirectory)
	{
