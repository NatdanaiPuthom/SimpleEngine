...
static void ImGui_ImplDX11_CreateWindow(ImGuiViewport* viewport)
{
    ...
    sd.BufferCount = 2; //NOTE(Natdanai 01/05/2024): Changed from 1 to 2 BufferCount for Flip
    sd.OutputWindow = hwnd;
    sd.Windowed = TRUE;
    sd.SwapEffect = DXGI_SWAP_EFFECT_FLIP_DISCARD; //NOTE(Natdanai 01/05/2024): Changed to FLIP_DISCARD
    sd.Flags = 0;
