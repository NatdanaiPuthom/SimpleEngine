...
namespace SCR
{
	...
	namespace Modify
	{
		...
		NodeID CreateNode(NodeGraph& aNodeGraph, std::string_view aName, bool& aSuccess, ScriptVec2 aPosition = ScriptVec2(), CommandTracker* aCommandTracker = nullptr, bool aCreateIfNameNotFound = true);
		...
		VarID GetVarIDByNodeID(NodeID aNodeID, NodeGraph& aNodeGraph, const Script& aScript);
